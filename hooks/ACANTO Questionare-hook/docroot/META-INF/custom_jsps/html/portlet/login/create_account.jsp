...
<aui:form action="<%= createAccountURL %>" method="post" name="fm">
	...
	<aui:fieldset column="<%= true %>">
		<aui:col width="<%= 50 %>">
			...
			<!--  FOREIGN LANGUAGES = ? -->	
		<aui:input  name="foreignLanguages" label="Foreign Languages" type="text">
		<aui:validator name="required" />
...
<!--  PROFESSION = OK -->
		<aui:input name="profession" label="Profession" type="text">
			<aui:validator name="required" />
...
<!--  PREFERENCES = ? -->	
		<aui:input name="preferences" label="Preferences" type="text">
			<aui:validator name="required" />
...
<!--  MARITAL STATUS = OK -->	
		<aui:select name="maritalStatus" label="Marital Status" no-empty-value="true">
...
<!--  INTERESTS = ? -->	
		<aui:field-wrapper label="Interests and Preferences" >
...
<!--  EDUCATION LEVEL = OK -->
		...
		<aui:select name="educationLevel" no-empty-value="true" label="Education Level">
